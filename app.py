...
def edit():
    if request.method == "POST":
        ...
        sekolah_data = None
        user_data = None
        biayapeserta_data = None
        verifikasi_data = None
        ...
        print("post")
        #waktuisi = datetime.utcnow
        kodepeserta_data = request.form["kode"]
        sekolah_data = request.form["sekolah"]
        user_data = request.form["user"]
        biayapeserta_data = request.form["biaya"]
        verifikasi_data = request.form["verifikasi"]
        session["kodepserta_session"]=kodepeserta_data
        session["sekolah_session"]=sekolah_data
        session["biayapeserta_session"]=biayapeserta_data
        session["verifikasi_session"]=verifikasi_data
        session["user_session"] = user_data
        if kodepeserta_data != "":
            edit.kodepeserta_data = kodepeserta_data
        if sekolah_data != "":
            edit.sekolah_data = sekolah_data
        if user_data != "":
            edit.user_data = user_data
        if biayapeserta_data != "":
            edit.biayapeserta_data = biayapeserta_data
        if verifikasi_data != "":
            edit.verifikasi_data = verifikasi_data

        cabang_data = request.form["cabang"]
        suratketerangan_data = request.form["surat"]
        session["cabang_session"] = cabang_data
        session["suratketerangan_session"] = suratketerangan_data
        if cabang_data != "":
            edit.cabang_data = cabang_data
            edit.inisialcabang_data = inisialcabang(cabang_data)
            edit.biaya_data = biaya(cabang_data)
        if suratketerangan_data != "":
            edit.suratketerangan_data = suratketerangan_data
        ...
        session["lahir_1_data"] = lahir_1_data
        if nama_1_data != "":
            edit.nama_1_data = nama_1_data
        if telpon_1_data != "":
            edit.telpon_1_data = telpon_1_data
        if email_1_data != "":
        ...
        session["lahir_2_data"] = lahir_2_data
        if nama_2_data != "":
            edit.nama_2_data = nama_2_data
        if telpon_2_data != "":
            edit.telpon_2_data = telpon_2_data
        if email_2_data != "":
            edit.email_2_data = email_2_data
        if lahir_2_data != "":
            edit.lahir_2_data = lahir_2_data
        ...
        session["lahir_3_data"] = lahir_3_data
        if nama_3_data != "":
            edit.nama_3_data = nama_3_data
        if telpon_3_data != "":
            edit.telpon_3_data = telpon_3_data
        if email_3_data != "":
        ...
        session["lahir_4_data"] = lahir_4_data
        if nama_4_data != "":
            edit.nama_4_data = nama_4_data
        if telpon_4_data != "":
            edit.telpon_4_data = telpon_4_data
        if email_4_data != "":
        ...
        session["lahir_5_data"] = lahir_5_data
        if nama_5_data != "":
            edit.nama_5_data = nama_5_data
        if telpon_5_data != "":
            edit.telpon_5_data = telpon_5_data
        if email_5_data != "":
        ...
        session["lahir_6_data"] = lahir_6_data
        if nama_6_data != "":
            edit.nama_6_data = nama_6_data
        if telpon_6_data != "":
            edit.telpon_6_data = telpon_6_data
        if email_6_data != "":
            edit.email_6_data = email_6_data
        if lahir_6_data != "":
            edit.lahir_6_data = lahir_6_data
        ...
        session["lahir_7_data"] = lahir_7_data
        if nama_7_data != "":
            edit.nama_7_data = nama_7_data
        if telpon_7_data != "":
            edit.telpon_7_data = telpon_7_data
        if email_7_data != "":
        ...
        session["lahir_8_data"] = lahir_8_data
        if nama_8_data != "":
            edit.nama_8_data = nama_8_data
        if telpon_8_data != "":
            edit.telpon_8_data = telpon_8_data
        if email_8_data != "":
        ...
        session["lahir_9_data"] = lahir_9_data
        if nama_9_data != "":
            edit.nama_9_data = nama_9_data
        if telpon_9_data != "":
            edit.telpon_9_data = telpon_9_data
        if email_9_data != "":
        ...
        session["lahir_10_data"] = lahir_10_data
        if nama_10_data != "":
            edit.nama_10_data = nama_10_data
        if telpon_10_data != "":
            edit.telpon_10_data = telpon_10_data
        if email_10_data != "":
            edit.email_10_data = email_10_data
        if lahir_10_data != "":
            edit.lahir_10_data = lahir_10_data
        ...
        session["lahir_11_data"] = lahir_11_data
        if nama_11_data != "":
            edit.nama_11_data = nama_11_data
        if telpon_11_data != "":
            edit.telpon_11_data = telpon_11_data
        if email_11_data != "":
        ...
        session["lahir_12_data"] = lahir_12_data
        if nama_12_data != "":
            edit.nama_12_data = nama_12_data
        if telpon_12_data != "":
            edit.telpon_12_data = telpon_12_data
        if email_12_data != "":
        ...
        session["lahir_13_data"] = lahir_13_data
        if nama_13_data != "":
            edit.nama_13_data = nama_13_data
        if telpon_13_data != "":
            edit.telpon_13_data = telpon_13_data
        if email_13_data != "":
        ...
        session["lahir_14_data"] = lahir_14_data
        if nama_14_data != "":
            edit.nama_14_data = nama_14_data
        if telpon_14_data != "":
            edit.telpon_14_data = telpon_14_data
        if email_14_data != "":
            edit.email_14_data = email_14_data
        if lahir_14_data != "":
            edit.lahir_14_data = lahir_14_data
        ...
        session["lahir_15_data"] = lahir_15_data
        if nama_15_data != "":
            edit.nama_15_data = nama_15_data
        if telpon_15_data != "":
            edit.telpon_15_data = telpon_15_data
        if email_15_data != "":
        ...
        session["lahir_16_data"] = lahir_16_data
        if nama_16_data != "":
            edit.nama_16_data = nama_16_data
        if telpon_16_data != "":
            edit.telpon_16_data = telpon_16_data
        if email_16_data != "":
        ...
        session["lahir_17_data"] = lahir_17_data
        if nama_17_data != "":
            edit.nama_17_data = nama_17_data
        if telpon_17_data != "":
            edit.telpon_17_data = telpon_17_data
        if email_17_data != "":
        ...
        session["lahir_18_data"] = lahir_18_data
        if nama_18_data != "":
            edit.nama_18_data = nama_18_data
        if telpon_18_data != "":
            edit.telpon_18_data = telpon_18_data
        if email_18_data != "":
            edit.email_18_data = email_18_data
        if lahir_18_data != "":
            edit.lahir_18_data = lahir_18_data
        ...
        session["lahir_19_data"] = lahir_19_data
        if nama_19_data != "":
            edit.nama_19_data = nama_19_data
        if telpon_19_data != "":
            edit.telpon_19_data = telpon_19_data
        if email_19_data != "":
        ...
        session["lahir_20_data"] = lahir_20_data
        if nama_20_data != "":
            edit.nama_20_data = nama_20_data
        if telpon_20_data != "":
            edit.telpon_20_data = telpon_20_data
        if email_20_data != "":
        ...
        tableid = edit._id
        inisial = edit.inisialcabang_data
        edit.kodepeserta_data = kodepeserta(tableid, inisial)
        if kodepeserta_data != "":
            edit.kodepeserta_data = kodepeserta_data
        edit.kodeunik_data = kodeunik(tableid)

        db.session.commit()

        edit.biayapeserta_data = biayapeserta(edit.biaya_data, edit.kodeunik_data)
        if biayapeserta_data != "":
            edit.biayapeserta_data = biayapeserta_data
